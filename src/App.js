        ...
        <header className="relative z-10">
          <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-full bg-slate-900 text-sm font-semibold uppercase tracking-[0.2em] text-amber-100">
                NP
              </div>
              <div>
                <p className="font-display text-lg">Nathan Porter</p>
                <p className="text-xs uppercase tracking-[0.32em] text-slate-500">
                  Portfolio 2026
                </p>
              </div>
            </div>
            <div className="hidden items-center gap-8 text-xs uppercase tracking-[0.35em] text-slate-600 md:flex">
              <span>Work</span>
              <span>Services</span>
              <span>About</span>
            </div>
            <button className="rounded-full border border-slate-900/20 bg-white/70 px-5 py-2 text-xs uppercase tracking-[0.3em] text-slate-900 backdrop-blur">
              Let&apos;s Talk
            </button>
          </nav>
